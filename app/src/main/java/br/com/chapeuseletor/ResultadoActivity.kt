...
class ResultadoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val idImagem = when (nomeCasa) {
            "Grifinória" -> R.drawable.gryffindor_logo // Use os nomes exatos dos seus arquivos!
            "Corvinal" -> R.drawable.ravenclaw_logo
            "Sonserina" -> R.drawable.slytherin_logo
            "Lufa-Lufa" -> R.drawable.hufflepuff_logo
